...
async def web_ui():
    ...
    # FIX: Used Triple Single Quotes to avoid Python syntax errors completely
    html_code = '''
    <!DOCTYPE html>
    <html lang="bn">
    <head>
        ...
        <style>
            ...
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .age-box { text-align: center; } .age-btn { width: 100%; padding: 15px; border-radius: 12px; font-weight: 700; border: none; font-size: 16px; cursor: pointer; margin-top: 15px; }
            .age-yes { background: #ef4444; color: white; } .age-no { background: #334155; color: white; }
